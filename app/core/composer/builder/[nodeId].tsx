...
import { EntityPickerModal } from '../../../../src/core/composer/ui/EntityPickerModal';
import { flattenComposerTree } from '../../../../src/core/composer/utils/flattenComposerTree';
...
export default function ComposerBuilder() {
    ...
    useEffect(() => {
        console.log('🛠 Builder loaded with nodeId:', nodeId);
    }, [nodeId]);
